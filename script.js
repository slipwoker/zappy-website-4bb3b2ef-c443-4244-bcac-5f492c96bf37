        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '4bb3b2ef-c443-4244-bcac-5f492c96bf37',
                name: data.name || '',
                email: data.email || '',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "RANCO uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
